...
import net.rs.vulkanium.client.render.model.*;
import net.rs.vulkanium.client.render.frapi.mesh.MeshViewImpl;
import net.rs.vulkanium.client.render.texture.SpriteFinderCache;
import net.rs.vulkanium.mixin.frapi.ItemRendererAccessor;
...
public class ItemRenderContext extends AbstractRenderContext {
    ...
    private void renderQuad(MutableQuadViewImpl quad) {
        ...
        bufferQuad(quad, vertexConsumer, quad.getQuadAtlas() == VulkaniumQuadAtlas.ITEM);
    }
     ...
     */
    private VertexConsumer getVertexConsumer(VulkaniumQuadAtlas quadAtlas, @Nullable ChunkSectionLayer quadRenderLayer, ItemStackRenderState.@Nullable FoilType quadGlint) {
        RenderType layer;
        ItemStackRenderState.FoilType glint;

        if (renderTypeGetter != null) {
            layer = renderTypeGetter.renderType(quadAtlas == VulkaniumQuadAtlas.BLOCK ? QuadAtlas.BLOCK : QuadAtlas.ITEM, quadRenderLayer);
    ...
    private VertexConsumer createVertexConsumer(RenderType type, ItemStackRenderState.FoilType glint) {
        if (glint == ItemStackRenderState.FoilType.SPECIAL) {
            ...
            return ItemRendererAccessor.vulkanium$getSpecialFoilBuffer(bufferSource, type, specialGlintEntry);
        }
