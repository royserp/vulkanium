...
public class MutableQuadViewWrapper extends QuadViewWrapper implements QuadEmitter {
    ...
    public QuadEmitter shadeMode(ShadeMode mode) {
        mutableQuad.setShadeMode(mode == ShadeMode.ENHANCED ? VulkaniumShadeMode.ENHANCED : VulkaniumShadeMode.VANILLA);
        return this;
    }

    @Override
    public QuadEmitter atlas(QuadAtlas quadAtlas) {
        mutableQuad.setQuadAtlas(quadAtlas == QuadAtlas.BLOCK ? VulkaniumQuadAtlas.BLOCK : VulkaniumQuadAtlas.ITEM);
        return this;
    }
    ...
    public QuadAtlas atlas() {
        return mutableQuad.getQuadAtlas() == VulkaniumQuadAtlas.BLOCK ? QuadAtlas.BLOCK : QuadAtlas.ITEM;
    }
