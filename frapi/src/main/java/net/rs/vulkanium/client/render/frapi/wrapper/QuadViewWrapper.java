...
public class QuadViewWrapper implements QuadView {
    ...
    public ShadeMode shadeMode() {
        return quad.getShadeMode() == VulkaniumShadeMode.ENHANCED ? ShadeMode.ENHANCED : ShadeMode.VANILLA;
    }

    @Override
    public QuadAtlas atlas() {
        return quad.getQuadAtlas() == VulkaniumQuadAtlas.BLOCK ? QuadAtlas.BLOCK : QuadAtlas.ITEM;
    }
