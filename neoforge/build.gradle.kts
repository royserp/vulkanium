...
base {
    archivesName = "vulkanium-neoforge"
}
...
tasks {
    jar {
        ...
        manifest.attributes["Automatic-Module-Name"] = "vulkanium_service"
        ...
        from(project(":common").sourceSets.main.get().output.resourcesDir!!.resolve("vulkanium-icon.png"))
    }
