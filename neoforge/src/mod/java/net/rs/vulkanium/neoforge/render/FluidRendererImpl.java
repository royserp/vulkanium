...
import net.rs.vulkanium.client.render.chunk.compile.pipeline.DefaultFluidRenderer;
...
public class FluidRendererImpl extends FluidRenderer {
    ...
    public void render(LevelSlice level, BlockState blockState, FluidState fluidState, BlockPos blockPos, BlockPos offset, TranslucentGeometryCollector collector, ChunkBuildBuffers buffers) {
        ...
        //
        // Vulkanium cannot let vanilla FluidRenderer#render run (during the invocation of FluidRenderHandler#renderFluid)
        // for two reasons.
        ...
        //
        // Due to all the above, Vulkanium injects into head of vanilla FluidRenderer#render before Fabric API and cancels
        ...
        // To allow invoking this method from the injector, where there is no local Vulkanium context, the renderer and
