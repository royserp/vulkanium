package net.rs.vulkanium.desktop;

import net.rs.vulkanium.desktop.utils.browse.BrowseUrlHandler;
...
public class LaunchWarn {
    private static final String HELP_URL = "https://link.caffeinemc.net/guides/vulkanium/installation";

    private static final String RICH_MESSAGE =
                    "<html>" +
                    "<body>" +
                    "<p style='width: 600px; padding: 0 0 8px 0;'>" +
                    "You have tried to launch Vulkanium (a Minecraft mod) directly, but it is not an executable program or mod installer. Instead, " +
    ...
    private static final String FAILED_TO_BROWSE_MESSAGE =
            "<html>" +
                    ...
                    "</body>" +
                    "</html>";
    public static final String WINDOW_TITLE = "Vulkanium";
