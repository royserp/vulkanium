package net.rs.vulkanium.client.compatibility.workarounds;
...
public class Workarounds {
    ...
    public static void init() {
        ...
        if (!workarounds.isEmpty()) {
            LOGGER.warn("Vulkanium has applied one or more workarounds to prevent crashes or other issues on your system: [{}]",
                    workarounds.stream()
                            .map(Enum::name)
    ...
    public enum Reference {
         ...
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/1816">GitHub Issue</a>
         */
         ...
         * Requesting a No Error Context causes a crash at startup when using a Wayland session on GLFW
           <3.4.
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/1624">GitHub Issue</a>
         */
         ...
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/2727">GitHub Issue</a>
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/3226">GitHub Issue</a>
         */
         ...
         * the base model.
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/2830">GitHub Issue</a>
         */
         ...
         * <a href="https://github.com/theroyalserpant/Vulkanium/issues/3318">GitHub Issue</a>
         */
