package net.rs.vulkanium.client.platform.windows.api.d3dkmt;

import net.rs.vulkanium.client.compatibility.environment.probe.GraphicsAdapterInfo;
import net.rs.vulkanium.client.compatibility.environment.probe.GraphicsAdapterVendor;
import net.rs.vulkanium.client.platform.windows.WindowsFileVersion;
import net.rs.vulkanium.client.platform.windows.api.Gdi32;
...
import static net.rs.vulkanium.client.platform.windows.api.Gdi32.*;
import static net.rs.vulkanium.client.platform.windows.api.d3dkmt.D3DKMTQueryAdapterInfoType.WDDM12.*;
import static org.lwjgl.system.MemoryUtil.memAddress;
import static org.lwjgl.system.MemoryUtil.memByteBuffer;

public class D3DKMT {
    private static final Logger LOGGER = LoggerFactory.getLogger("Vulkanium-D3DKMT");
