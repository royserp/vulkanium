...
import net.rs.vulkanium.client.platform.windows.api.d3dkmt.D3DKMT;
...
public class GraphicsAdapterProbe {
    private static final Logger LOGGER = LoggerFactory.getLogger("Vulkanium-GraphicsAdapterProbe");
