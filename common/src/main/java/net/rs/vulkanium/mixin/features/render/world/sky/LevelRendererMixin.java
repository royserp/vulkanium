package net.rs.vulkanium.mixin.features.render.world.sky;
...
public abstract class LevelRendererMixin {
     ...
     *
     * <p>When updating Vulkanium to new releases of the game, please check for new
    ...
    private boolean preRenderSky(LivingEntity instance, Holder<MobEffect> p_316430_, Operation<Boolean> original) {
        ...
        // This prevents the sky from being visible through chunks culled by Vulkanium's fog occlusion.
