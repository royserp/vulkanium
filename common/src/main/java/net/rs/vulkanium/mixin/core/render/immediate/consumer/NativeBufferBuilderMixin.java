package net.rs.vulkanium.mixin.core.render.immediate.consumer;

import com.mojang.blaze3d.vertex.BufferBuilder;
import com.mojang.blaze3d.vertex.ByteBufferBuilder;
import com.mojang.blaze3d.vertex.VertexFormat;
import net.rs.vulkanium.api.memory.MemoryIntrinsics;
...
import net.rs.vulkanium.client.render.vertex.buffer.BufferBuilderExtension;
...
public abstract class NativeBufferBuilderMixin implements VertexBufferWriter, BufferBuilderExtension {
    @Shadow
    ...
    @Override
    public void vulkanium$duplicateVertex() {
        if (this.vertices == 0) {
            return;
        }
