package net.rs.vulkanium.mixin.core.render.frustum;

import net.rs.vulkanium.client.render.viewport.frustum.SimpleFrustum;
...
public class FrustumMixin implements ViewportProvider {
    ...
    @Override
    public Viewport vulkanium$createViewport() {
