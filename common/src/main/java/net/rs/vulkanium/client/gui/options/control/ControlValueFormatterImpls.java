    ...
    public static ControlValueFormatter biomeBlend() {
        return (v) -> {
            if (v < 0 || v > 7) {
                ...
                int sv = 2 * v + 1;
                return Component.translatable("vulkanium.options.biome_blend.value", sv, sv);
            }
        };
    }
    ...
    public static ControlValueFormatter chunkFade() {
        return (v -> {
            if (v == 0) {
                ...
                return Component.translatable("vulkanium.options.chunk_fade_time.value", (double) v / 1000.0);
            }
        });
    }
}
