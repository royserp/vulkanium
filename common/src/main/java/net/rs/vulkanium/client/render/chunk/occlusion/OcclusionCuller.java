package net.rs.vulkanium.client.render.chunk.occlusion;

import it.unimi.dsi.fastutil.longs.Long2ReferenceMap;
import net.rs.vulkanium.client.render.chunk.RenderSection;
import net.rs.vulkanium.client.render.chunk.lists.RenderSectionVisitor;
import net.rs.vulkanium.client.render.viewport.CameraTransform;
import net.rs.vulkanium.client.render.viewport.Viewport;
import net.rs.vulkanium.client.util.collections.DoubleBufferedQueue;
import net.rs.vulkanium.client.util.collections.ReadQueue;
import net.rs.vulkanium.client.util.collections.WriteQueue;
