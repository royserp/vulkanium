...
import net.rs.vulkanium.client.render.helper.TextureHelper;
...
import static net.rs.vulkanium.client.render.model.EncodingFormat.*;
...
public abstract class MutableQuadViewImpl extends QuadViewImpl implements ListStorage {
    ...
    static {
        ...
        quad.setQuadAtlas(VulkaniumQuadAtlas.BLOCK);
    ...
    public TextureAtlasSprite sprite(VulkaniumSpriteFinder finder) {
    ...
    public MutableQuadViewImpl setShadeMode(VulkaniumShadeMode mode) {
    ...
    public final MutableQuadViewImpl setQuadAtlas(VulkaniumQuadAtlas atlas) {
    ...
    public final MutableQuadViewImpl fromBakedQuad(BakedQuad quad) {
        ...
        VulkaniumQuadAtlas atlas = VulkaniumQuadAtlas.of(quad.materialInfo().sprite().atlasLocation());

        if (atlas == null) {
            atlas = VulkaniumQuadAtlas.BLOCK;
        }
