...
public abstract class AbstractWidget implements Renderable, GuiEventListener, NarratableEntry, Dimensioned {
    ...
    protected void text(GuiGraphicsExtractor graphics, String text, int x, int y, int color) {
        graphics.text(this.font, text, x, y, color);
    }

    protected void text(GuiGraphicsExtractor graphics, Component text, int x, int y, int color) {
        graphics.text(this.font, text, x, y, color);
    }

    protected void centeredText(GuiGraphicsExtractor graphics, Component text, int x, int y, int color) {
