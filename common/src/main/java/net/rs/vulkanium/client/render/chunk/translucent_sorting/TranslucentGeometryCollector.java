...
import net.rs.vulkanium.client.render.chunk.translucent_sorting.bsp_tree.BSPBuildFailureException;
import net.rs.vulkanium.client.render.chunk.translucent_sorting.data.*;
import net.rs.vulkanium.client.render.chunk.translucent_sorting.quad.FullTQuad;
import net.rs.vulkanium.client.render.chunk.translucent_sorting.quad.RegularTQuad;
...
public class TranslucentGeometryCollector {
    ...
    private final QuadSplittingMode quadSplittingMode = VulkaniumClientMod.options().performance.quadSplittingMode;
     ...
     * cases: <a href="https://hackmd.io/@douira100/vulkanium-sl-gfni#Special-Sorting-Cases">...</a>
     * <p>
