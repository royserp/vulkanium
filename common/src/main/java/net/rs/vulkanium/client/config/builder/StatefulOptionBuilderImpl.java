...
import net.rs.vulkanium.api.config.structure.StatefulOptionBuilder;
import net.rs.vulkanium.client.config.AnonymousOptionBinding;
import net.rs.vulkanium.client.config.structure.StatefulOption;
import net.rs.vulkanium.client.config.value.ConstantValue;
import net.rs.vulkanium.client.config.value.DependentValue;
import net.rs.vulkanium.client.config.value.DynamicValue;
