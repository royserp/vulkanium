...
import net.rs.vulkanium.client.config.structure.*;
...
import net.rs.vulkanium.client.gui.options.control.AbstractOptionList;
...
public class OptionListWidget extends AbstractOptionList {
    ...
    private abstract static class HeaderWidget extends AbstractWidget {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
            ...
            this.text(graphics, this.truncateLabelToFit(this.title), this.getX() + Layout.OPTION_PAGE_MARGIN, this.getCenterY() + Layout.REGULAR_TEXT_BASELINE_OFFSET, this.textColor);
        }
    ...
    private static class ModHeaderWidget extends HeaderWidget {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
            ...
            this.text(graphics, truncateTextToFit(this.title, this.getWidth() - textOffset), this.getX() + textOffset, textY, this.textColor);
        }
    }
