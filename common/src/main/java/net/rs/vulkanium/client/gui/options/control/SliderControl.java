...
import net.rs.vulkanium.client.config.structure.StatefulOption;
    ...
    static class SliderControlElement extends ControlElement {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
            ...
            if (drawSlider) {
                ...
                this.text(graphics, label, sliderX - labelWidth - 6, sliderY + (sliderHeight / 2) + Layout.REGULAR_TEXT_BASELINE_OFFSET, Colors.FOREGROUND);
            } else {
                this.text(graphics, label, sliderX + sliderWidth - labelWidth, sliderY + (sliderHeight / 2) + Layout.REGULAR_TEXT_BASELINE_OFFSET, Colors.FOREGROUND);
            }
