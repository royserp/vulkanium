...
public class ScrollableTooltip {
    private static final Identifier ARROW_TEXTURE = Identifier.fromNamespaceAndPath("vulkanium", "textures/gui/tooltip_arrows.png");
    ...
    private int generateTooltipContent(int boxWidth, boolean needsScrolling) {
        ...
        if (impact != null) {
            var impactText = Component.translatable("vulkanium.options.performance_impact_string", impact.getName());
