...
import net.rs.vulkanium.client.config.search.SearchQuerySession;
...
public class SearchWidget extends AbstractParentWidget {
    ...
    private void rebuildForWidth(int width) {
        ...
        this.searchBox = new EditBox(
                ...
                searchBoxWidth - 20,
                Layout.BUTTON_SHORT,
                Component.translatable("vulkanium.options.search")
        );
        ...
        this.searchBox.setHint(
                Component.translatable("vulkanium.options.search.hint")
