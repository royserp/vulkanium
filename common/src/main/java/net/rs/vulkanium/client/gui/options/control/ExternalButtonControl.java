...
import net.rs.vulkanium.client.config.structure.ExternalButtonOption;
...
public class ExternalButtonControl implements Control {
    public static final Component BASE_BUTTON_TEXT = Component.translatable("vulkanium.options.open_external_page_button");
