...
public interface PlatformModelAccess {
     ...
     */
    VulkaniumModelDataContainer getModelDataContainer(Level level, SectionPos sectionPos);

    /**
     * Should not use. <b>Use {@code VulkaniumModelData.EMPTY} instead.</b>
     * @return The empty model data for this platform.
     */
    @ApiStatus.Internal
    VulkaniumModelData getEmptyModelData();
