package net.rs.vulkanium.client.render.vertex.serializers;

import com.mojang.blaze3d.vertex.VertexFormat;
import it.unimi.dsi.fastutil.longs.Long2ReferenceMap;
import it.unimi.dsi.fastutil.longs.Long2ReferenceOpenHashMap;
import net.rs.vulkanium.api.vertex.format.VertexFormatExtensions;
import net.rs.vulkanium.client.render.vertex.serializers.generated.VertexSerializerFactory;
import net.rs.vulkanium.api.vertex.serializer.VertexSerializer;
import net.rs.vulkanium.api.vertex.serializer.VertexSerializerRegistry;
...
public class VertexSerializerRegistryImpl implements VertexSerializerRegistry {
    ...
    static {
        var classDumpPath = System.getProperty("vulkanium.codegen.dump", null);
    ...
    private static int getGlobalId(VertexFormat format) {
        return ((VertexFormatExtensions) format).vulkanium$getGlobalId();
    }
}
