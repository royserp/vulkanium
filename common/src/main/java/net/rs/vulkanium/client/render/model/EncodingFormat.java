...
import net.rs.vulkanium.client.render.helper.GeometryHelper;
...
public final class EncodingFormat {
    ...
    private static final VulkaniumShadeMode[] SHADE_MODES = VulkaniumShadeMode.values();
    private static final int SHADE_MODE_COUNT = SHADE_MODES.length;
    private static final VulkaniumQuadAtlas[] QUAD_ATLASES = VulkaniumQuadAtlas.values();
    ...
    static VulkaniumShadeMode shadeMode(int bits) {
        return SHADE_MODES[(bits & SHADE_MODE_MASK) >>> SHADE_MODE_BIT_OFFSET];
    }

    static int shadeMode(int bits, VulkaniumShadeMode mode) {
        return (bits & ~SHADE_MODE_MASK) | (mode.ordinal() << SHADE_MODE_BIT_OFFSET);
    }

    static VulkaniumQuadAtlas quadAtlas(int bits) {
        return QUAD_ATLASES[(bits & QUAD_ATLAS_MASK) >>> QUAD_ATLAS_BIT_OFFSET];
    }

    static int quadAtlas(int bits, VulkaniumQuadAtlas quadAtlas) {
