package net.rs.vulkanium.client.model.light;

import net.rs.vulkanium.client.model.light.data.LightDataAccess;
import net.rs.vulkanium.client.model.light.flat.FlatLightPipeline;
import net.rs.vulkanium.client.model.light.smooth.SmoothLightPipeline;
