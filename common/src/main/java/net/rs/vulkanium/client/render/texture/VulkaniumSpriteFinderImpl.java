 ...
 * a fixed cell size.
 */
public class VulkaniumSpriteFinderImpl implements VulkaniumSpriteFinder {
    private static final Logger LOGGER = LoggerFactory.getLogger(VulkaniumSpriteFinderImpl.class);

    private final Node root;
    private final TextureAtlasSprite missingSprite;
    private final VulkaniumQuadAtlas atlas;
    private int badSpriteCount = 0;

    public VulkaniumSpriteFinderImpl(Map<Identifier, TextureAtlasSprite> sprites, TextureAtlasSprite missingSprite, VulkaniumQuadAtlas atlas) {
    ...
    @Override
    public VulkaniumQuadAtlas getAtlas() {
        return atlas;
    }
