package net.rs.vulkanium.client.data.config;

import net.rs.vulkanium.client.services.PlatformMixinOverrides;
import net.rs.vulkanium.client.services.Services;
import net.rs.vulkanium.mixin.MixinOption;
...
/**
 * <a href="https://github.com/theroyalserpant/Vulkanium/wiki/Configuration-File">Documentation of these options...</a>
 */
@SuppressWarnings("CanBeFinal")
public class MixinConfig {
    protected static final Logger LOGGER = LogManager.getLogger("VulkaniumConfig");
    ...
    private static void writeDefaultConfig(File file) throws IOException {
        ...
        try (Writer writer = new FileWriter(file)) {
            writer.write("# This is the configuration file for Vulkanium.\n");
            writer.write("#\n");
            writer.write("# You can find information on editing this file and all the available options here:\n");
            writer.write("# https://github.com/theroyalserpant/Vulkanium/wiki/Configuration-File\n");
            writer.write("#\n");
