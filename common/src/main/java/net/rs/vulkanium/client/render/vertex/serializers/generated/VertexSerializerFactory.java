package net.rs.vulkanium.client.render.vertex.serializers.generated;
...
public class VertexSerializerFactory {
    ...
    public static Bytecode generate(VertexFormat srcFormat, VertexFormat dstFormat, String identifier) {
        ...
        var name = "net/rs/vulkanium/client/render/vertex/serializers/generated/VertexSerializer$Impl$" + identifier;
